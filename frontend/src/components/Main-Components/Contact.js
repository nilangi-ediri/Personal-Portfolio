            ...
            <div className="custom-container">
                <div className="contact-content content-width">
                    <div className="section-header">
                        ...
                        <h1 className="scroll-animation" data-aos='fade-up'>Looking for a Software Engineer?<span>Let’s Connect!</span></h1>
                    </div>
                    <h3 className="scroll-animation" data-aos='fade-up'>nilangi.ediri@gmail.com</h3>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                <div className="input-group">
                                    ...
                                    <input type="text" name="subject" id="subject" placeholder="Share the topic of your message..." />
